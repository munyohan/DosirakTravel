		...
		<div class="row">
			<div class="col-md-offset-3 col-md-6">
				...
				<div id="mybag-window">
                    ...
                    <div class="col-md-6">
                        <a href="#" data-backdrop="static" data-target="#itemInfoModal" data-toggle="modal"><div class="item-slot inbag"> 도시락</div></a>
                    </div>

                    <div class="col-md-6">
                        <a href="#" data-backdrop="static" data-target="#itemInfoModal" data-toggle="modal"><div class="item-slot inbag"> 티켓</div></a>
                    </div>
				</div>
			</div>
			<div class="col-md-3">
				<div id="gameBtns">
					<a href="#" class="btn btn-warning"><img class ="icon" src="../images/backpack.png"/> 내가방</a>
					<a href="collection.jsp" class="btn btn-warning"><img class ="icon" src="../images/inventory.png"/> 수집품</a>
