...
<!-- custom CSS & JS -->
<link href="../css2/inventory.css" type="text/css" rel="stylesheet" />
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-offset-3 col-md-6">
				...
				<div id="homeBtn">
					<a href="main.do"><img src="../images/home.png" /></a>
				</div>
							...
							<c:forEach items="${ilist}" var="item">
								<div class="item-slot inbag">
									<a href="#" data-backdrop="static" data-target="#itemInfoModal" data-toggle="modal">
										<img kind="${item.itemkind}" title="${item.imgname}" class="item-slot-image" src="../images/${item.imgname}" alt="" />
									</a>
									<div class="itemQtyBox">
	                          			 <p class="itemQty">${item.amount}</p>
	                       			</div>	
								</div>
							</c:forEach>
						</div>
			...
			<div class="col-md-3">
				<div id="gameBtns">
					...
					<a href="collection.do" class="btn btn-warning">
						<img class="icon" src="../images/inventory.png" /> 수집품
					</a>
					<a href="../shop/shop.do" class="btn btn-warning">
	...
	function printData(resData) {
		...
		$.each(resData, function(index, item) {
			result += '<div class="item-slot inbag">'
					+ '<a href="#" data-backdrop="static" data-target="#itemInfoModal" data-toggle="modal">'
					+ '<img kind="'+item["itemkind"]+'" title="'+item["imgname"]+'" class="item-slot-image" src="../images/'+item["imgname"]+'" alt="" /></a>'
					+ '<div class="itemQtyBox"><p class="itemQty">'+item["amount"]+'</p></div></div>'
					$("#inventory-inner-window").html(result);
		});
	}
	
	function printNullData() {
		var result = '<div></div>';
		$("#inventory-inner-window").html(result);
	}
</script>
